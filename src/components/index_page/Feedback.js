...
function Feedback() {
  return (
    <section className="section-padding pb-0" id="feedback">
            ...
            >
              <figure className="reviews-thumb d-flex flex-wrap align-items-center rounded">
                ...
                <p className="reviews-text w-100">
                  Phasellus ligula ante, tempus ac imperdiet ut, mattis ac nibh.
              ...
              <figure className="reviews-thumb d-flex flex-wrap align-items-center rounded">
                ...
                <p className="reviews-text w-100">
                  Donec in elementum orci, nec posuere ligula. Quisque vulputate
                  diam et ullamcorper ullamcorper. Pellentesque vestibulum neque
                  at leo fermentum mattis.
                </p>
                <img
